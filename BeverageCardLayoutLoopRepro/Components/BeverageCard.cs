...
public sealed partial class BeverageCard : Component
{
	public override VisualNode Render()
	{
		...
		const string imageUrl =
			"https://beerboxstaging.blob.core.windows.net/images/_mock%20Grey%20Goose.webp";
		...
		return Grid(
			"*,Auto",
			"*",
			RenderBeverageImage(imageUrl).GridRow(0),
			...
			VStack(
					...
					Label(string.Join(sep, tags)).LineBreakMode(LineBreakMode.WordWrap),
					Label($"size {size}{sep}price {price:¥#,0} (tax incl.)")
						.HStart()
